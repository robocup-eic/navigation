...
class ImageListener:
    ...
    def imageDepthCallback(self, data):
        try:
            ...
            pix = (int(round(cv_image.shape[0]/2)), int(round(cv_image.shape[1]/2)))
            self.pix = pix
...
def main():
    depth_image_topic = '/walkie/camera/depth/image_rect_raw'
    depth_info_topic = '/walkie/camera/depth/camera_info'
    ...
    listener = ImageListener('/walkie/camera/depth/image_rect_raw', '/walkie/camera/depth/camera_info')
    rospy.spin()
